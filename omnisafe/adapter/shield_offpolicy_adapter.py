...
class ShieldOnlineAdapter:
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        self._env: CMDP = make(env_id, num_envs=num_envs, device=self._device, use_shield=cfgs.algo_cfgs.use_shield, shield_threshold=cfgs.algo_cfgs.shield_threshold) # tell cmdp env to use shield wrapper
        self._eval_env: CMDP = make(env_id, num_envs=1, device=self._device, use_shield=cfgs.algo_cfgs.use_shield, shield_threshold=cfgs.algo_cfgs.shield_threshold, use_deepreach=cfgs.algo_cfgs.use_deepreach) # tell cmdp env to use shield wrapper
