...
class OnPolicyRespoAdapter(OnlineAdapter):
    """OnPolicy Adapter for OmniSafe.
                ...
                if epoch_end or done or time_out:
                    ...
                    if not done:
                        if epoch_end:
                            ...
                            _, last_value_r, last_value_c, last_value_p, _ = agent.step(obs[idx])
                        if time_out:
                            _, last_value_r, last_value_c, last_value_p, _ = agent.step(
