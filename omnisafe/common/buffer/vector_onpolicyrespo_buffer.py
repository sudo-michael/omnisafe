...
from omnisafe.common.buffer.onpolicyrespo_buffer import OnPolicyRespoBuffer
from omnisafe.typing import DEVICE_CPU, AdvatageEstimator, OmnisafeSpace
from omnisafe.utils import distributed


class VectorOnPolicyRespoBuffer(OnPolicyRespoBuffer):
    ...
    def __init__(  # pylint: disable=super-init-not-called,too-many-arguments
        ...
        self.buffers: list[OnPolicyRespoBuffer] = [
            OnPolicyRespoBuffer(
                obs_space=obs_space,
                act_space=act_space,
                size=size,
